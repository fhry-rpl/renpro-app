...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-gray-100 dark:bg-dark-bg">
        <div class="min-h-screen">
            ...
            @isset($header)
                <header class="bg-white dark:bg-dark-surface border-b border-border dark:border-dark-border shadow-sm">
                    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                        <h2 class="heading-h2 text-gray-900 dark:text-dark-text">{{ $header }}</h2>
                    </div>
                </header>
            @endisset
